...
const lineOne = `Having over ${calculateAge('26/01/2012')} years of experience in software development, I have worked for companies in the web hosting, online auction, E-commerce, and telecommunications.`;
const lineTwo = 'I bring to the table a robust skill set encompassing cutting-edge technologies including React(JS/Native), Angular, Redux, Saga, Thunk, XState, and Hooks. My expertise extends to backend technologies like Node, Python, and I have experience working with distributed systems such as Kafka. I\'m proficient in containerization with Docker, experienced in orchestrating applications with Kubernetes, and well-versed in setting up CI/CD pipelines using Jenkins. I\'m enthusiastic about delivering top-notch solutions and exploring innovative ways to leverage technology for business excellence.';
        ...
        <div className="flex flex-row pt-5 w-3/4 pl-32">
            <div className="w-1/2 justify-start">
                <NewIcon
                    ...
                    iconTitle="Mail"
                    twoToneColor="#12c2e9"
                    value="agiri.chandra@gmail.com"
                    onClick={() => window.open(
                        "mailto:agiri.chandra@gmail.com", "_blank")}
                />
            </div>
            <div className="w-1/2 justify-start">
                <NewIcon
        ...
        <div className="flex pb-5 flex-row pt-5 w-3/4 pl-32">
            <div className="w-1/2 justify-start">
                <NewIcon
                    ...
                    iconTitle="LinkedIn"
                    twoToneColor="#12c2e9"
                    value="Chandra-Prakash-Agiri"
                    onClick={() => window.open(
                        "https://www.linkedin.com/in/chandraprakashagiri/", "_blank")}
                />
            </div>
            <div className="w-1/2 justify-start">
                <NewIcon
                    ...
                    iconTitle="Git"
                    twoToneColor="#eb2f96"
                    value="ChandraPrakashAgiri"
                    onClick={() => window.open(
                        "https://github.com/chandu6839", "_blank")}
                />
            </div>
        </div>
        <div className="flex flex-row pt-5 w-3/4 pl-32">
